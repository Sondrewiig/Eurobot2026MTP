...
class OverheadRectifierNode(Node):
    ...
    def _load_highway_corridor_config(self):
        ...
        for base in [
            os.path.join(workspace, "src", "main_bot_control", "main_bot_control", "config"),
            os.path.join(workspace, "install", "main_bot_control", "share", "main_bot_control", "config"),
        ]:
            candidate_path = os.path.join(base, "control_tuning.yaml")

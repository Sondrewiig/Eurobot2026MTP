...
class ZedStereoSplitter(Node):
    def __init__(self):
        ...
        default_workspace = os.environ.get("EUROBOT_WS", os.getcwd())
        self.declare_parameter(
            "left_calibration_yaml",
            os.path.join(default_workspace, "config", "zed_left_camera.yaml"),
        )
        self.declare_parameter(
            "right_calibration_yaml",
            os.path.join(default_workspace, "config", "zed_right_camera.yaml"),
        )
